...
import AddSpaceStore from "../../api/AddSpaceStore";
import LoginStore from "../../api/LoginStore";

const AddAdSpaceSpaceForm = () => {
    ...
    return (
        <div data-testid="addAdSpaceSpaceForm-1" style={{paddingTop: "64px"}}>
            <NavbarUser/>
...
export default AddAdSpaceSpaceForm;
