            ...
            <div style={{ marginBottom: "10px" }}>
              ...
              <FormGroup>
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={selectedCategories.includes("Digital Billboard")}
                      onChange={() => handleCategoryChange("Digital Billboard")}
                    />
                  }
                  label={
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      onChange={() =>
                        handleCategoryChange("Print Media Spaces")
                      }
                    />
                  }
                  label={
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      onChange={() =>
                        handleCategoryChange("Transit Advertising")
                      }
                    />
                  }
                  label={
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      onChange={() =>
                        handleCategoryChange("Shopping Mall Spaces")
                      }
                    />
                  }
                  label={
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={selectedCategories.includes("Online Platforms")}
                      onChange={() => handleCategoryChange("Online Platforms")}
                    />
                  }
                  label={
                    <span style={{ fontSize: "0.9rem" }}>Online Platforms</span>
                  }
                />
              </FormGroup>
            </div>
            <div style={{ marginBottom: "10px" }}>
              ...
              <FormGroup>
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={selectedCountries.includes("Poland")}
                      onChange={() => handleCountryChange("Poland")}
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={selectedCountries.includes("Japan")}
                      onChange={() => handleCountryChange("Japan")}
                    />
                  }
            ...
            <div>
              ...
              <FormGroup>
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={selectedCities.includes("Poznan")}
                      onChange={() => handleCityChange("Poznan")}
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={selectedCities.includes("Wroclaw")}
                      onChange={() => handleCityChange("Wroclaw")}
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={selectedCities.includes("Warsaw")}
                      onChange={() => handleCityChange("Warsaw")}
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={selectedCities.includes("Cracow")}
                      onChange={() => handleCityChange("Cracow")}
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      onChange={() => handleCityChange("New York")}
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={selectedCities.includes("Chicago")}
                      onChange={() => handleCityChange("Chicago")}
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      onChange={() => handleCityChange("Los Angeles")}
                    />
                  }
                  label={
                    <span style={{ fontSize: "0.9rem" }}>Los Angeles</span>
                  }
                />
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      onChange={() => handleCityChange("San Francisco")}
                    />
                  }
                  label={
                    <span style={{ fontSize: "0.9rem" }}>San Francisco</span>
                  }
                />
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      onChange={() => handleCityChange("Tokyo")}
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={selectedCities.includes("Kyoto")}
                      onChange={() => handleCityChange("Kyoto")}
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={selectedCities.includes("Osaka")}
                      onChange={() => handleCityChange("Osaka")}
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={selectedCities.includes("Yokohama")}
                      onChange={() => handleCityChange("Yokohama")}
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={selectedCities.includes("Berlin")}
                      onChange={() => handleCityChange("Berlin")}
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={selectedCities.includes("Hamburg")}
                      onChange={() => handleCityChange("Hamburg")}
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={selectedCities.includes("Frankfurt")}
                      onChange={() => handleCityChange("Frankfurt")}
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={selectedCities.includes("Munich")}
                      onChange={() => handleCityChange("Munich")}
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={selectedCities.includes("Nice")}
                      onChange={() => handleCityChange("Nice")}
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={selectedCities.includes("Lyon")}
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={selectedCities.includes("Marseille")}
            ...
            >
              {filteredOfficeSpaces.map((space) => (
                <div
                  key={space.id}
                  style={{
                    width: "calc(100% / 3 - 20px)", // 3 items per row with spacing
                    minWidth: "280px", // Prevent items from shrinking too much
                  }}
                >
