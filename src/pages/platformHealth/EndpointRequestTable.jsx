...
const EndpointRequestsTable = () => {
  ...
  useEffect(() => {
   ...
   const successfulRequestsCount = requests.filter(request => request.status_code === 200).length;
   const failedRequestsCount = requests.filter(request => request.status_code !== 200).length;
   const totalRequestsCount = requests.length;
   const successPercentage = ((successfulRequestsCount / totalRequestsCount) * 100).toFixed(2);
            ...
            <Paper elevation={4}>
                ...
                <Table>
                    ...
                    {requests.map((request) => (
                        ...
                        <TableCell align="center">{request.status_code}</TableCell>
